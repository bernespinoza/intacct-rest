...
require 'intacct_rest/model/bill'
require 'intacct_rest/model/bill_line'
...
require 'intacct_rest/endpoints/create_bill'
require 'intacct_rest/endpoints/create_bill_line'
